...
void main() {
  ...
  testWidgets("Do some shit", (WidgetTester tester) async {
    ...
    var appConfig = AppConfig(
      ...
      stripePublicKey: "pk_test_dH4Ng3fe6Jt9BHUFGOOCtGtu00sbOkbqGA",
    ...
    await tester.pumpWidget(MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider<UserRepository>(
          create: (context) => UserProvider(localStorageRepository: context.read()),
        ),
        ...
        RepositoryProvider<GymRepository>(
          create: (context) => GymProvider(localStorageRepository: context.read()),
        ),
